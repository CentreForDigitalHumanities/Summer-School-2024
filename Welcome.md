...
- Installation instructions. You can find them below. We recommend using [Anaconda Navigator](https://github.com/CentreForDigitalHumanities/Summer-School-2024/edit/main/Welcome.md#anaconda-navigator) and [Jupyter Lab](https://github.com/CentreForDigitalHumanities/Summer-School-2024/edit/main/Welcome.md#jupyter-lab) for the Summer School. If you have another preferred programming environment, you are welcome to use that as well, but we can not ensure that we will have the space and time to assist you with technical issues specific to your environment. 
